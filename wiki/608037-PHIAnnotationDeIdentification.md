...
An instance of the example NLP Sandbox PHI deidentifier is available at https://phi-deidentifier.nlpsandbox.io. See NLP Sanbdox tool can easily be deployed using Docker using the instruction available in the GitHub repository [nlpsandbox/phi-deidentifier-example].
